            ...
            <div className="mx-auto max-w-2xl pt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <Image src={'/assets/logo/Logo2.svg'} alt="logo" className='pb-4' width={50} height={50}/>
                        ...
                        <div className='flex gap-4'>
                            <Link href="/"><Image src={'/assets/footer/insta.svg'} alt="instagram" className='footer-icons' width={50} height={50} /></Link>
                            <Link href="/"><Image src={'/assets/footer/dribble.svg'} alt="dribble" className='footer-icons' width={50} height={50} /></Link>
                            <Link href="/"><Image src={'/assets/footer/twitter.svg'} alt="twitter" className='footer-icons' width={50} height={50} /></Link>
                            <Link href="/"><Image src={'/assets/footer/youtube.svg'} alt="youtube" className='footer-icons' width={50} height={50} /></Link>
                        </div>
                    </div>
                        ...
                        <div className="relative text-white focus-within:text-white flex flex-row-reverse">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2">
                                <button type="submit" className="p-1 focus:outline-none focus:shadow-outline">
                                    <Image src={'/assets/footer/inputIcon.svg'} alt="inputicon" layout="fill" objectFit="contain" />
                                </button>
                            </div>
                        </div>
                    </div>
